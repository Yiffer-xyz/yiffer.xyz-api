...
export default class PatreonRouter extends BaseRouter {
  ...
  async getAllPatrons() {
    ...
    let allPatrons = await this.databaseFacade.execute(query, null, 'Error getting all patrons from database', 'Get all patrons')
    return [...allPatrons]
  }
  ...
  async getSupportersForList() {
    ...
    let supporters = await this.databaseFacade.execute(query, null, 'Failed getting patreon supporters', 'Get patrons for list')
    return supporters
  }
  ...
  async getRandomVIPSupporter(req, res) {
    try {
      ...
      let supporters = await this.databaseFacade.execute(query, null, 'Failed getting VIP patreon supporters', 'Get random VIP patron')
